          ...
          {safeItems.map((p, idx) => {
            ...
            <div key={p.name} className={"product-wrap" + colClass}>
              <Link
                ...
                className="w-[130px] h-[130px] sm:w-[150px] sm:h-[150px] md:w-[180px] md:h-[180px] lg:w-[220px] lg:h-[220px] rounded-full relative overflow-hidden text-white shadow-md sm:shadow-lg product-card transition-all duration-300 active:scale-95"
                onMouseMove={(e) => {
